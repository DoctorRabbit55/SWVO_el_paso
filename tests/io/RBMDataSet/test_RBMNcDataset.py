...
def test_getattr_with_valid_variable(mock_dataset: RBMNcDataSet):
...
def test_getattr_with_invalid_variable(mock_dataset: RBMNcDataSet):
    """Test __getattr__ with an invalid variable."""
    with pytest.raises(AttributeError):
        _ = mock_dataset.NonExistentAttribute


def test_getattr_with_similar_variable(mock_dataset: RBMNcDataSet):
...
def test_computed_invv_variable(mock_dataset: RBMNcDataSet):
...
def test_computed_p_variable(mock_dataset: RBMNcDataSet):
...
def test_create_date_list_monthly(mock_dataset: RBMNcDataSet):
...
def test_create_date_list_daily(mock_dataset: RBMNcDataSet):
...
def test_file_name_stem_generation(mock_dataset: RBMNcDataSet):
...
def test_invalid_cadence_raises(mock_dataset: RBMNcDataSet):
...
def test_invalid_folder_type_raises(mock_dataset: RBMNcDataSet):
...
def test_get_var_method(mock_dataset: RBMNcDataSet):
